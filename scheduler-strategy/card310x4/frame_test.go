...
func TestCNPUName(t *testing.T) {
	convey.Convey("Test card310x4 Name", t, func() {
		npu := New(PluginName)
...
func TestCNPUIsMyTask(t *testing.T) {
	convey.Convey("Test card310x4 IsMyTask", t, func() {
		npu := New(PluginName)
		...
		convey.Convey("IsMyTask() should return error when task is of chip mode", func() {
...
func TestCNPUIsMyNode(t *testing.T) {
	convey.Convey("Test card310x4 IsMyNode", t, func() {
		npu := New(PluginName)
...
func TestCNPUIsMyJob(t *testing.T) {
	convey.Convey("Test card310x4 IsMyJob", t, func() {
		npu := New(PluginName)
...
func TestCNPUValidNPUJobFnInvalidSelector(t *testing.T) {
	convey.Convey("Test card310x4 ValidNPUJobFnInvalidSelector", t, func() {
		const (
...
func TestCNPUValidNPUJobFnInvalidNum(t *testing.T) {
	convey.Convey("Test card310x4 ValidNPUJobFnInvalidNum", t, func() {
		const (
			invalidNum0 = "0"
			invalidNum5 = "5"
			validNum1   = "1"
		...
		convey.Convey("ValidNPUJobFn() should return error for job with valid request number 4", func() {
			tasks = append(tasks, api.NewTaskInfo(buildNPUPod(
				CPodInfo{namespace: "default", groupName: "npu-group-19",
					podName: "npu-test-42", nodeName: nodeName, reqCPUNum: "20", reqMem: "5Gi",
...
func TestCNPUValidNPUJobFnInvalidModel(t *testing.T) {
	convey.Convey("Test card310x4 ValidNPUJobFnInvalidModel", t, func() {
		const (
			num4 = "4"
			num5 = "5"
			num1 = "1"
		...
		convey.Convey("ValidNPUJobFn() should return nil", func() {
			tasks = append(tasks, api.NewTaskInfo(buildNPUPod(
				CPodInfo{namespace: "default", groupName: "npu-group-23",
					podName: "npu-test-46", nodeName: nodeName, reqCPUNum: "20", reqMem: "5Gi",
...
func TestCnpuPreCheckNodeFnSuccess(t *testing.T) {
	convey.Convey("Test card310x4 PreCheckNodeFnSuccess", t, func() {
		npu := New(PluginName)
		var confs []conf.Configuration
		node := buildNPUNode(CNodeInfo{nodeName: nodeName, nodeArch: huaweiArchX86, cpu: "192", mem: "755Gi",
...
func TestCnpuCheckNPUResourceStableFn(t *testing.T) {
	convey.Convey("Test card310x4 CheckNPUResourceStableFn", t, func() {
		npu := New(PluginName)
...
func TestCnpuGetNPUAffinityBestNodesFnReq1(t *testing.T) {
	convey.Convey("Test card310x4 GetNPUAffinityBestNodesFn When Request is 1", t, func() {
		const (
			nodeName1 = "centos1"
			nodeName2 = "centos2"
			nodeName3 = "centos3"
		...
		convey.Convey("GetNPUAffinityBestNodesFn() should return correct result when request NPU num is 1", func() {
			...
			convey.So(result[nodeName1], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName2], convey.ShouldEqual, constNum1)
			convey.So(result[nodeName3], convey.ShouldEqual, constNum1)
			convey.So(result[nodeName4], convey.ShouldEqual, constNum3)
			convey.So(len(result), convey.ShouldEqual, constNum4)
...
func TestCnpuGetNPUAffinityBestNodesFnReq2(t *testing.T) {
	convey.Convey("Test card310x4 GetNPUAffinityBestNodesFn When Request is 2", t, func() {
		const (
			nodeName1 = "centos1"
			nodeName2 = "centos2"
			nodeName3 = "centos3"
		...
		convey.Convey("GetNPUAffinityBestNodesFn() should return correct result when request NPU num is 2", func() {
			...
			result, err := npu.GetNPUAffinityBestNodesFn(task, nodes, false)
			convey.So(result[nodeName1], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName2], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName3], convey.ShouldEqual, constNum1)
			convey.So(result[nodeName4], convey.ShouldEqual, constNum2)
			convey.So(err, convey.ShouldBeNil)
		})
	})
}
...
func TestCnpuGetNPUAffinityBestNodesFnReq3(t *testing.T) {
	convey.Convey("Test card310x4 GetNPUAffinityBestNodesFn When Request is 3", t, func() {
		const (
			nodeName1 = "centos1"
			nodeName2 = "centos2"
			nodeName3 = "centos3"
		...
		convey.Convey("GetNPUAffinityBestNodesFn() should return correct result when request NPU num is 3", func() {
			pod := buildNPUPod(CPodInfo{namespace: "default", groupName: "npu-group-17",
				podName: "npu-test-17", nodeName: nodeName, reqCPUNum: "20", reqMem: "5Gi",
			...
			convey.So(result[nodeName1], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName2], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName3], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName4], convey.ShouldEqual, constNum1)
			convey.So(err, convey.ShouldBeNil)
		})
	})
}
...
func TestCnpuGetNPUAffinityBestNodesFnReq4(t *testing.T) {
	convey.Convey("Test card310x4 GetNPUAffinityBestNodesFn When Request is 4", t, func() {
		const (
			nodeName1 = "centos1"
			nodeName2 = "centos2"
			nodeName3 = "centos3"
		...
		convey.Convey("GetNPUAffinityBestNodesFn() should return correct result when request NPU num is 4", func() {
			pod := buildNPUPod(CPodInfo{namespace: "default", groupName: "npu-group-17",
				podName: "npu-test-17", nodeName: nodeName, reqCPUNum: "20", reqMem: "5Gi",
			...
			convey.So(result[nodeName2], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName3], convey.ShouldEqual, constNum0)
			convey.So(result[nodeName4], convey.ShouldEqual, constNum0)
			convey.So(err, convey.ShouldBeNil)
		})
	})
}
...
func TestCnpuGetNPUAffinityBestNodesFnError(t *testing.T) {
	convey.Convey("Test card310x4 GetNPUAffinityBestNodesFnError", t, func() {
		const (
			nodeName1 = "centos1"
			nodeName2 = "centos2"
		)
		...
		convey.Convey("GetNPUAffinityBestNodesFn() should return error when request number is greater than 4", func() {
...
func TestCnpuScoreBestNPUNodesFn(t *testing.T) {
	convey.Convey("Test card310x4 ScoreBestNPUNodesFn", t, func() {
		const (
			nodeName1 = "euler1"
			nodeName2 = "euler2"
		)
...
func TestCnpuScoreBestNPUNodesFnError(t *testing.T) {
	convey.Convey("Test card310x4 ScoreBestNPUNodesFnError", t, func() {
		const (
			nodeName1 = "euler1"
			nodeName2 = "euler2"
		)
...
func TestCnpuUpdateNPUNodeUsedCardFn1(t *testing.T) {
	convey.Convey("Test card310x4 UpdateNPUNodeUsedCardFn", t, func() {
		npu := New(PluginName)
		node := buildNPUNode(CNodeInfo{nodeName: nodeName, nodeArch: huaweiArchX86, cpu: "192", mem: "755Gi",
...
func TestCnpuUpdateNPUNodeUsedCardFnError1(t *testing.T) {
	convey.Convey("Test card310x4 UpdateNPUNodeUsedCardFnError", t, func() {
		npu := New(PluginName)
...
func TestCnpuGetReleaseNPUTopologyFn(t *testing.T) {
	convey.Convey("Test card310x4 GetReleaseNPUTopologyFn", t, func() {
		npu := New(PluginName)
...
func TestCnpuGetReleaseNPUTopologyFnError(t *testing.T) {
	convey.Convey("Test card310x4 GetReleaseNPUTopologyFnError", t, func() {
		npu := New(PluginName)
...
func TestCnpuUpdateReleaseNPUNodeTopologyFn(t *testing.T) {
	convey.Convey("Test card310x4 UpdateReleaseNPUNodeTopologyFn", t, func() {
		npu := New(PluginName)
		node := buildNPUNode(CNodeInfo{nodeName: nodeName, nodeArch: huaweiArchX86, cpu: "192", mem: "755Gi",
			npuAllocateNum: "4", npuTop: "Ascend310-0,Ascend310-2,Ascend310-3,Ascend310-1"})
		node.Others = map[string]interface{}{
...
func TestCnpuGetAllocatedNPUFromTopologyFn(t *testing.T) {
	convey.Convey("Test card310x4 GetAllocatedNPUFromTopologyFn", t, func() {
		npu := New(PluginName)
...
func TestCnpuGetAllocatedNPUFromTopologyFnError(t *testing.T) {
	convey.Convey("Test card310x4 GetAllocatedNPUFromTopologyFnError", t, func() {
		npu := New(PluginName)
...
func TestCnpuGetFitCardFromNodeByPriorityFn(t *testing.T) {
	convey.Convey("Test card310x4 GetFitCardFromNodeByPriorityFn", t, func() {
		...
		convey.Convey("getFitCardFromNodeByPriorityFn() should return correct result "+
			...
			priorityArray := [cardNPUNumber]int{1, NPUID3, NPUID2, NPUID4}
		...
		convey.Convey("getFitCardFromNodeByPriorityFn() should return correct result "+
			...
			priorityArray := [cardNPUNumber]int{NPUID2, NPUID3, NPUID4}
			result, err := getFitCardFromNodeByPriority(nodeTop, priorityArray)
			convey.So(err, convey.ShouldBeNil)
			convey.So(result, convey.ShouldNotBeNil)
		})
		...
		convey.Convey("getFitCardFromNodeByPriorityFn() should return correct result "+
			...
			priorityArray := [cardNPUNumber]int{NPUID3, NPUID4}
			result, err := getFitCardFromNodeByPriority(nodeTop, priorityArray)
			convey.So(err, convey.ShouldBeNil)
			convey.So(result, convey.ShouldNotBeNil)
		})
		...
		convey.Convey("getFitCardFromNodeByPriorityFn() should return correct result "+
			...
			priorityArray := [cardNPUNumber]int{NPUID4}
			result, err := getFitCardFromNodeByPriority(nodeTop, priorityArray)
			convey.So(err, convey.ShouldBeNil)
			convey.So(result, convey.ShouldNotBeNil)
		})
...
func TestCnpuSetNPUTopologyToPodFn(t *testing.T) {
	convey.Convey("Test card310x4 SetNPUTopologyToPodFn", t, func() {
		npu := &card310x4{}
		...
		convey.Convey("SetNPUTopologyToPodFn() should return error when top is of wrong type", func() {
			...
			convey.So(err, convey.ShouldBeError)
			convey.So(task.Pod.Annotations[a310NPUCardName], convey.ShouldEqual, "")
		})
		convey.Convey("SetNPUTopologyToPodFn() should write correct info in pod annotation", func() {
			...
			err := npu.SetNPUTopologyToPodFn(task, top)
			convey.So(err, convey.ShouldBeNil)
			convey.So(task.Pod.Annotations[a310NPUCardName], convey.ShouldEqual, expectedResult)
		})
	})
}
...
func setNodeOthers(node *api.NodeInfo) {
