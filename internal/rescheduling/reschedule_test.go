...
type FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoTests struct {
	fields  *FaultNode
	name    string
...
func buildFaultNodeGetNetworkUnhealthyCardsFromDeviceInfoTests() []FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoTests {
	node2 := fakeNPUNodeWithDeviceInfo("node0")
	test1 := FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoTests{
		name:   "01-FaultNodeGetNodeHeartbeatIntervalFromDeviceInfoTests() nil device info",
		fields: fakeTestFaultNodeNodeHealthy("node0"),
		args: FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoArgs{
			node:     fakeNPUNodeNilDeviceInfo("node0"),
	...
	test2 := FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoTests{
		name:   "02-FaultNodeGetNodeHeartbeatIntervalFromDeviceInfoTests() succeed",
		fields: fakeTestFaultNodeNodeHealthy("node0"),
		args: FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoArgs{
			node:     node2,
	...
	tests := []FaultNodeGetNetworkUnhealthyCardsFromDeviceInfoTests{
		test1,
		test2,
	}
	return tests
