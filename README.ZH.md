...
-   [Ascend-volcano-plugin介绍](#Ascend-volcano-plugin介绍)
-   [亲和性策略说明](#亲和性策略说明)
-   [调度算法设计说明](#调度算法设计说明)
-   [调度算法实现说明](#调度算法实现说明)
-   [编译说明](#编译说明)
-   [版本更新记录](#版本更新记录)
<h2 id="Ascend-volcano-plugin介绍">Ascend-volcano-plugin介绍</h2>

基于开源Volcano调度的插件机制，增加昇腾处理器的亲和性调度，虚拟设备调度等特性，最大化发挥昇腾处理器计算性能。

<h2 id="亲和性策略说明">亲和性策略说明</h2>
...
![](figures/Ascend-910-AI-Processor-interconnection-topology.zh.png "Ascend-910-AI-Processor-interconnection-topology")
...
![](figures/Affinity-algorithm-design-process.zh.png "Affinity-algorithm-design-process")
...
<h2 id="调度算法实现说明">调度算法实现说明</h2>

## 程序流程设计说明<a name="section7199282319"></a>

**图 1**  Affinity program process \(Volcano part\)<a name="fig11310145516212"></a>  
![](figures/Affinity-program-process-(Volcano-part).zh.png "Affinity-program-process-(Volcano-part)")
...
1.  将Volcano v1.3.0版本官方开源代码放至“$GOPATH/src/volcano.sh/volcano“。
...
<tbody><tr id="row1683152117244"><td class="cellrowborder" valign="top" width="26.662666266626662%" headers="mcps1.1.4.1.1 "><p id="p86612143014"><a name="p86612143014"></a><a name="p86612143014"></a>v2.0.2</p>
</td>
